        ...
        <div ref={dropdown}>
          ...
          <ul className="mb-4">
            <li className="py-1 px-3">
              <label className="flex items-center">
                ...
                <span className="text-sm font-medium ml-2">Products</span>
              </label>
            </li>
            <li className="py-1 px-3">
              <label className="flex items-center">
          ...
          <div className="py-2 px-3 border-t border-gray-200 bg-gray-50">
            <ul className="flex items-center justify-between">
              ...
              <li>
                <button className="btn-xs bg-green-500 hover:bg-green-600 text-white" onClick={() => setDropdownOpen(false)} onBlur={() => setDropdownOpen(false)}>Apply</button>
              </li>
            </ul>
          </div>
        </div>
